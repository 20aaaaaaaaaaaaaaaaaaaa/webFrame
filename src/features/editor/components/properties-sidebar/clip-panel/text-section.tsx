  ...
  return (
    <>
      <PropertySection title={t('properties.text', 'Text')} icon={Type} defaultOpen={true}>
        ...
        <PropertyRow label={t('properties.content', 'Content')}>
          <Textarea
            ...
            placeholder={sharedValues.text === undefined ? t('properties.mixed', 'Mixed') : t('properties.enterText', 'Enter text...')}
        ...
        <PropertyRow label={t('properties.font', 'Font')} className="items-start">
          <FontPicker
            ...
            placeholder={sharedValues.fontFamily === undefined ? t('properties.mixed', 'Mixed') : t('properties.selectFont', 'Select font')}
        ...
        <PropertyRow label={t('properties.weight', 'Weight')}>
          ...
          >
            <SelectTrigger className="h-7 text-xs flex-1 min-w-0">
              <SelectValue placeholder={sharedValues.fontWeight === undefined ? t('properties.mixed', 'Mixed') : t('properties.selectWeight', 'Select weight')} />
            </SelectTrigger>
            <SelectContent>
        ...
        <PropertyRow label={t('properties.style', 'Style')}>
          <div className="flex gap-1">
            <Button
              ...
              title={canUseBold ? t('properties.bold', 'Bold') : t('properties.boldNotAvailable', 'Bold is not available for this font')}
        ...
        {/* Line Height */}
        <PropertyRow label={t('properties.lineHeight', 'Line H.')}>
          <NumberInput
      ...
      <PropertySection title={t('properties.effects', 'Effects')} icon={Sparkles} defaultOpen={true}>
        ...
        <PropertyRow label={t('properties.shadowBlur', 'Shadow B.')}>
          <NumberInput
            value={shadowBlur}
      ...
      <PropertySection title={t('timeline.animation', 'Animation')} icon={Sparkles} defaultOpen={true}>
        ...
        <div className="px-1 pt-1 text-[11px] text-muted-foreground">
          {t('properties.animationHint', 'Applies short ease-out text motion at the start or end of each selected clip.')}
        </div>
      </PropertySection>
    </>
  );
