      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
        <TabsList className="grid w-full grid-cols-3 h-8">
          ...
          >
            ...
            {t('properties.transform', 'Transform')}
          </TabsTrigger>
          <TabsTrigger
            value="effects"
            ...
            <>
              ...
              {hasAdjustmentItems && (
                <div className="px-2 py-2 text-xs text-muted-foreground bg-purple-500/10 rounded border border-purple-500/20">
                  {t('properties.adjustmentLayerHint', 'Effects on adjustment layers apply to all items on tracks above.')}
                </div>
              )}
