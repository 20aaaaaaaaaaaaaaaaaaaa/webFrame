...
function getClipHeader(items: HeaderItem[], t: TFunction) {
  ...
  const fallbackLabel = t('properties.clipsSelected', { count: logicalCount, defaultValue: `${logicalCount} clip(s) selected` });
    ...
    <>
            ...
            >
              <div className="min-w-0 flex items-center gap-1">
                <Button
                  ...
                  data-tooltip={propertiesFullColumn ? t('properties.dockToPreview', 'Dock to preview') : t('properties.expandFullColumn', 'Expand full column')}
                ...
                <h2 className="min-w-0 flex items-center gap-1.5 text-xs font-semibold text-muted-foreground">
                  <span className="shrink-0 uppercase tracking-wide">{t('editor.properties', 'Properties')}</span>
                  {activeClipHeader && (
                    <>
      ...
      {!rightSidebarOpen && (
        <button
          ...
          data-tooltip={t('properties.showPanel', 'Show Properties Panel')}
