...
export function MarkerPanel() {
  ...
  if (!selectedMarker) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-xs text-muted-foreground">{t('properties.markerNotFound', 'Marker not found')}</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <PropertySection title={t('properties.marker', 'Marker')} icon={MapPin} defaultOpen={true}>
        {/* Frame position */}
        <PropertyRow label={t('properties.frame', 'Frame')}>
          <NumberInput
        ...
        {/* Timecode (read-only) */}
        <PropertyRow label={t('properties.time', 'Time')}>
        ...
        {/* Label */}
        <PropertyRow label={t('properties.label', 'Label')}>
          <Input
        ...
        <div className="pt-2">
          ...
          >
            ...
            {t('properties.deleteMarker', 'Delete Marker')}
          </Button>
        </div>
      </PropertySection>
    </div>
