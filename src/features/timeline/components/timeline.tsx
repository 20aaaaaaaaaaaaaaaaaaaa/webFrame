...
export const Timeline = memo(function Timeline({ duration, onGraphPanelOpenChange }: TimelineProps) {
  ...
  return (
      ...
      <div className="timeline-bg h-full border-t border-border flex flex-col overflow-hidden" role="region" aria-label={t('timeline.timeline', 'Timeline')}>
        {/* Timeline Header */}
        <TimelineHeader
          ...
          >
            ...
            <div className="flex items-center gap-1">
              ...
              <Button
                ...
                title={activeTrackId
                  ? t('timeline.addTrackAbove', 'Add track (inserts above selected)')
                  : t('timeline.addTrackTop', 'Add track at top')}
              >
              ...
              <Button
                ...
                title={
                  tracks.length === 0
                    ? t('timeline.noTracksToRemove', 'No tracks to remove')
                    : !activeTrackId && selectedTrackIds.length === 0
                    ? t('timeline.selectTrackToRemove', 'Select a track to remove')
                    : selectedTrackIds.length > 0
                    ? t('timeline.removeSelectedTracks', 'Remove {{count}} selected track(s)', { count: selectedTrackIds.length })
                    : t('timeline.removeActiveTrack', 'Remove active track')
                }
              >
