...
export const StretchHandles = memo(function StretchHandles({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "absolute left-0 top-0 bottom-0 w-2 bg-green-700 cursor-ew-resize transition-opacity duration-75",
      ...
      <div
        className={cn(
          "absolute right-0 top-0 bottom-0 w-2 bg-green-700 cursor-ew-resize transition-opacity duration-75",
